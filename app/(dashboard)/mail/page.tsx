...
export default function Mail() {
    ...
    return (
        <main className="h-full bg-gray-900">
            ...
            <div className='justify-center flex p-2 sm:p-4'>
                <Card className="w-full max-w-4xl bg-gray-700 border border-gray-700 text-white">
                    <CardHeader>
                        <CardTitle className="text-center mb-4 text-xl sm:text-2xl">
                            Temp Mail Plus Generator
                        </CardTitle>
                        <CardDescription className="text-gray-300 text-center mb-4 text-base sm:text-xl">
                            Gunakan email sementara ini untuk verifikasi. Klik pesan untuk melihat atau menyembunyikan detail.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="grid gap-2">
                            <Label className="h-[50px] sm:h-[60px] border border-gray-700 w-full justify-center text-lg sm:text-[20px] text-white flex items-center px-2 sm:px-4 break-all">
                                {tempEmail}
                            </Label>
